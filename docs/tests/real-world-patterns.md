...
- `docs/tests/schema-and-types.md`
- `docs/tests/quality-and-completeness.md`
...
Relevant repo categories:
- `docs/tests/quality-and-completeness.md`
- `docs/tests/integrity-and-references.md`
...
Relevant repo categories:
- `docs/dimensions/processing.md`
- `docs/tests/performance-and-freshness.md`
...
Relevant repo categories:
- `docs/tests/anomaly-and-drift.md`
- `docs/dimensions/processing.md`
...
2. Map the pattern to the existing category in `docs/tests/`.
