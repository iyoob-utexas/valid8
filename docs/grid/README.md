...
- `docs/grid/test-grid.md` — the core checklist of tests, with DPPF ID mappings.
- `docs/grid/summary-test-grid.md` — the summary scorecard for pass rate, gate readiness, and health metrics.
- `docs/grid/lineage-map.md` — the end-to-end lineage map: Mermaid pipeline diagram, zone-to-zone validation table, and lineage coverage checklist.
- `docs/grid/raci-matrix.md` — roles and accountability for each category.
- `docs/grid/tier-dimension-reference.md` — severity tier definitions and DAMA dimension mapping.
- `docs/grid/standards-references.md` — the credible standards this framework follows.
- `docs/grid/README.md` — the reference for how to use the text-based grid.
