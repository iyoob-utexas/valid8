...
The repo already includes cross-validation guidance in the master `domains/data/grid/test-grid.md` matrix and the `domains/data/tests/integrity-and-references.md` category. The suite above makes those checks explicit and groups them into coordinated validation behavior.
