...
This checklist is the primary output of Phase 1 through Phase 3 of the DPPF engagement methodology described in `domains/data/process/testing-strategy.md`. Complete it before scoring findings and before setting a target maturity level.
...
5. Score any Gap or Partial items using the DPPF severity model in `domains/data/framework/README.md`.

---

## Structural domain

Tests in this domain: `domains/data/tests/schema-and-types.md`
...
| STR-016 | Data contract design review | | |

Structural coverage: _____ Covered / _____ Partial / _____ Gap out of 16

---

## Semantic domain

Tests in this domain: `domains/data/tests/integrity-and-references.md`
...
Tests in this domain: `domains/data/tests/anomaly-and-drift.md`
...
Tests in this domain: `domains/data/tests/performance-and-freshness.md`
...
Tests in this domain: `domains/data/tests/observability-and-operations.md`
...
| OPS-016 | Pipeline cutover parity | | |

Operational coverage: _____ Covered / _____ Partial / _____ Gap out of 16

---

## Adversarial domain

Tests in this domain: `domains/data/tests/adversarial.md`
...
Tests in this domain: `domains/data/tests/cross-validation-suite.md`
...
Use the domain coverage matrix from `domains/data/framework/maturity-model.md` alongside total coverage to estimate the pipeline maturity level.
...
1. Score every Gap and Partial item using the DPPF severity model in `domains/data/framework/README.md`.
2. Use the scores to prioritize the remediation backlog.
3. Add new test IDs to the project test grid in `domains/data/grid/test-grid.md`.
