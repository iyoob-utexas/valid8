...
Use this model to assess where a pipeline or team currently sits, and to set a target level for a given engagement or roadmap cycle. For a coverage self-assessment, use `domains/data/framework/dppf.md`.
...
**Characteristics:**
- Coverage review completed on a scheduled cycle using `domains/data/framework/dppf.md`
- Every gap scored with the DPPF severity model from `domains/data/framework/README.md`
...
1. At kickoff, use the attack surface map in `domains/data/framework/README.md` to identify which pipeline zones are in scope.
2. Complete the coverage self-assessment in `domains/data/framework/dppf.md` to identify which DPPF test categories are currently covered.
